...
@Entity(tableName= cDatabase.TABLENAME_MOVEORDERBARCODE)
public class cMoveorderBarcodeEntity {
    ...
    //Region Constructor
    public cMoveorderBarcodeEntity() {

    }

    public cMoveorderBarcodeEntity(JSONObject pvJsonObject) {
        try {
