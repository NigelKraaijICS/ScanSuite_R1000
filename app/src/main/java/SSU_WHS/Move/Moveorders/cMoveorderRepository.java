...
public class cMoveorderRepository {
    ...
    public cWebresult pCreateMoveOrderViaWebserviceWrs(String pvDocumentStr, String pvBinCodeStr, boolean pvCheckBarcodesBln) {
        ...
        try {
            webResultWrs = new mCreateMoveOrderViaWebserviceAsyncTask().execute(moveCreateParams).get();
...
//            FFF
    ...
    private static class mCreateMoveOrderViaWebserviceAsyncTask extends AsyncTask<MoveCreateParams, Void, cWebresult> {
        @Override
