...
public class cPackagingAdapter extends RecyclerView.Adapter<cPackagingAdapter.PackagingViewHolder> {
    ...
    @NonNull
    @Override
    public cPackagingAdapter.PackagingViewHolder onCreateViewHolder(@NonNull ViewGroup pvViewGroup, int pvViewTypeInt) {
    ...
    @Override
    public void onBindViewHolder(final cPackagingAdapter.PackagingViewHolder pvHolder, final int pvPositionInt) {
        ...
        pvHolder.imageButtonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                cPackaging.currentPackaging.quantityUsedInt = newQuantity;
            }
        });
