...
public class cPackagingOutAdapter extends RecyclerView.Adapter<cPackagingOutAdapter.PackagingViewHolder> {
    ...
    @NonNull
    @Override
    public cPackagingOutAdapter.PackagingViewHolder onCreateViewHolder(@NonNull ViewGroup pvViewGroup, int pvViewTypeInt) {
    ...
    @Override
    public void onBindViewHolder(final cPackagingOutAdapter.PackagingViewHolder pvHolder, final int pvPositionInt) {
        ...
        pvHolder.imageButtonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                cPackaging.currentPackaging.quantityOutUsedInt = newQuantity;
