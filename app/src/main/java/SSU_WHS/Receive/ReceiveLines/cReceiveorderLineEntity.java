...
@Entity(tableName= cDatabase.TABLENAME_RECEIVELINES)
public class cReceiveorderLineEntity {
    ...
    //empty constructor
    public cReceiveorderLineEntity() {

    }

    public cReceiveorderLineEntity(JSONObject pvJsonObject) {
        try {
            this.lineNoInt = pvJsonObject.getInt(cDatabase.SORTINGSEQUENCENO_NAMESTR) ;
            ...
            this.sortingSequenceNoStr =  pvJsonObject.getInt(cDatabase.SORTINGSEQUENCENO_NAMESTR) ;
            ...
            this.handledTimeStampStr = pvJsonObject.getString(cDatabase.HANDLEDTIMESTAMP_NAMESTR);
    ...
    public cReceiveorderLineEntity(JSONObject pvJsonObject, boolean pvLineCreatedBln) {
        try {
            this.lineNoInt = pvJsonObject.getInt(cDatabase.SORTINGSEQUENCENOTAKE_NAMESTR) ;
            this.itemNoStr = pvJsonObject.getString(cDatabase.ITEMNO_NAMESTR);
            this.variantCodeStr = pvJsonObject.getString(cDatabase.VARIANTCODE_NAMESTR);
            this.descriptionStr = pvJsonObject.getString(cDatabase.DESCRIPTION_NAMESTR);
            this.description2Str = pvJsonObject.getString(cDatabase.DESCRIPTION2_NAMESTR);
            this.binCodeStr = cUser.currentUser.currentBranch.getBranchStr();
            this.quantityDbl = cText.pStringToDoubleDbl(pvJsonObject.getString(cDatabase.QUANTITYTAKE_NAMESTR));
            this.quantityHandledDbl = cText.pStringToDoubleDbl(pvJsonObject.getString(cDatabase.QUANTITYTAKENOTEXPORTED_NAMESTR));
            this.sortingSequenceNoStr =  pvJsonObject.getInt(cDatabase.SORTINGSEQUENCENOTAKE_NAMESTR) ;
            this.vendorItemNoStr = pvJsonObject.getString(cDatabase.VENDORITEMNO_NAMESTR);
            this.vendorItemDescriptionStr = pvJsonObject.getString(cDatabase.VENDORITEMDESCRIPTION_NAMESTR);
            this.localStatusInt =  cWarehouseorder.IntakeMATLineLocalStatusEnu.LOCALSTATUS_NEW;
            this.handledTimeStampStr = pvJsonObject.getString(cDatabase.HANDLEDTIMESTAMPTAKENOTEXPORTED_NAMESTR);
    ...
    public int getSortingSequenceInt() {return this.sortingSequenceNoStr;}
