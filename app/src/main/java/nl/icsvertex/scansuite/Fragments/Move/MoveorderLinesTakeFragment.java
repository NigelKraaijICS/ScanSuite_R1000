...
public class MoveorderLinesTakeFragment extends Fragment implements iICSDefaultFragment {
    ...
    //Region Constructor
    public MoveorderLinesTakeFragment() {
    ...
    public void mFindViews() {
        ...
        this.recyclerViewMoveorderLinesDone = getView().findViewById(R.id.recyclerViewMoveorderLinesTake);
    ...
    public static void pGetData(List<cMoveorderLine> pvDataObl) {
        ...
        MoveorderLinesTakeFragment.mFillRecycler(pvDataObl);
    }
    ...
    private static void mFillRecycler(List<cMoveorderLine> pvDataObl) {
        ...
        MoveorderLinesTakeFragment.recyclerViewMoveorderLinesDone.setHasFixedSize(false);
        MoveorderLinesTakeFragment.recyclerViewMoveorderLinesDone.setAdapter(cMoveorderLine.getMoveorderLineDoneAdapter());
        MoveorderLinesTakeFragment.recyclerViewMoveorderLinesDone.setLayoutManager(new LinearLayoutManager(cAppExtension.context));
        MoveorderLinesTakeFragment.recyclerViewMoveorderLinesDone.setVisibility(View.VISIBLE);
    ...
    public static void pNoLinesAvailable(Boolean pvEnabledBln) {
        ...
        if (MoveorderLinesActivity.currentLineFragment != null && MoveorderLinesActivity.currentLineFragment instanceof MoveorderLinesDoneFragment) {
            ...
            MoveorderLinesTakeFragment.recyclerViewMoveorderLinesDone.setVisibility(View.INVISIBLE);
