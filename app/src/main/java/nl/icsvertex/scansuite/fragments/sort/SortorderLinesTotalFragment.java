...
public class SortorderLinesTotalFragment extends Fragment {
    Context thisContext;
    String currentUser;
    String currentBranch;
    String chosenOrder;

    RecyclerView recyclerViewSortorderLinesTotal;
    ...
    private void m_findViews() {
        recyclerViewSortorderLinesTotal = getView().findViewById(R.id.recyclerViewSortorderLinesTotal);
    }
    ...
    private void m_setSortorderLineRecycler(List<cPickorderLineEntity> pickorderLinesEntities) {
        pickorderLineAdapter = new cPickorderLineAdapter(thisContext);
        recyclerViewSortorderLinesTotal.setHasFixedSize(false);
        recyclerViewSortorderLinesTotal.setAdapter(pickorderLineAdapter);
        recyclerViewSortorderLinesTotal.setLayoutManager(new LinearLayoutManager(thisContext));
