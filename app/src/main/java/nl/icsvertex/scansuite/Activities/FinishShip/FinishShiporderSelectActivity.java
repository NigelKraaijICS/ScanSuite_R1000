...
public class FinishShiporderSelectActivity extends AppCompatActivity implements iICSDefaultActivity, SwipeRefreshLayout.OnRefreshListener {
    ...
    private  RecyclerView recyclerFinishViewShiporders;
    ...
    public void mActivityInitialize() {
        ...
        this.mSetToolbar(getResources().getString(R.string.screentitle_finish_shiporderselect));
    ...
    public void mFindViews() {
        ...
        this.recyclerFinishViewShiporders = findViewById(R.id.recyclerViewFinishShiporders);
    ...
    public  void pFinishShiporderSelected(cPickorder pvPickorder) {
    ...
    private  void mHandleFillOrders() {
        ...
        if (!cPickorder.pGetFinishShipOrdersViaWebserviceBln(true, "")) {
    ...
    private  void mHandleFinishShipOrderSelected() {
        ...
        hulpResult = cPickorder.currentPickOrder.pGetFinishShippingDetailsRst();
    ...
    private void mApplyFilter() {
        ...
        this.mSetRecycler(filteredPicksObl);
    }
    ...
    private  void mSetRecycler(List<cPickorder> pvPickorderObl) {
        ...
        this.recyclerFinishViewShiporders.setHasFixedSize(false);
        this.recyclerFinishViewShiporders.setAdapter(this.getPickorderAdapter());
        this.recyclerFinishViewShiporders.setLayoutManager(new LinearLayoutManager(cAppExtension.context));
    ...
    private  boolean mTryToLockOrderBln() {
        ...
        cResult hulpResult;
        hulpResult = cPickorder.currentPickOrder.pLockViaWebserviceRst(cWarehouseorder.StepCodeEnu.Finish_Packing, cWarehouseorder.WorkflowPickStepEnu.PickFinishPacking);
    ...
    private  void mShowShipLinesSinglePiecesActivity() {

        cUserInterface.pCheckAndCloseOpenDialogs();

        final ViewGroup container = cAppExtension.activity.findViewById(R.id.container);

        Intent intent = new Intent(cAppExtension.context, FinishShipLinesActivity.class);
    ...
    private void mReleaseLicense() {
        ...
        if (!cLicense.pReleaseLicenseViaWebserviceBln()) {
            cUserInterface.pShowSnackbarMessage(recyclerFinishViewShiporders, cAppExtension.activity.getString(R.string.message_license_release_error), null, false);
        }
