...
public class QualityControlSelectActivity extends AppCompatActivity implements iICSDefaultActivity, SwipeRefreshLayout.OnRefreshListener {
    ...
    private  RecyclerView recyclerViewQCOrders;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qcorder_select);
    ...
    public void mActivityInitialize() {
        ...
        this.mSetToolbar(getResources().getString(R.string.screentitle_qcorderselect));
    ...
    public void mFindViews() {
        ...
        this.recyclerViewQCOrders = findViewById(R.id.recyclerViewQCOrders);
    ...
    public void mSetToolbar(String pvScreenTitleStr) {
        this.toolbarImage.setImageResource(R.drawable.ic_qualitycontrol);
    ...
    public  void pQCOrderSelected(cPickorder pvPickorder) {
    ...
    private  void mHandleFillOrders() {
        ...
        if (!cPickorder.pGetQCOrdersViaWebserviceBln(true, "")) {
        ...
        cAppExtension.activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mSetSQCOrderRecycler(cPickorder.allPickordersObl);
    ...
    private  void mHandleQCOrderSelected() {
...
//        }
    ...
    private void mApplyFilter() {
        ...
        this.mSetSQCOrderRecycler(filteredPicksObl);
    }
        ...
        cAppExtension.activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (pvShowBln) {
                    ...
                    recyclerViewQCOrders.setVisibility(View.INVISIBLE);
                ...
                recyclerViewQCOrders.setVisibility(View.VISIBLE);
    ...
    private  void mSetSQCOrderRecycler(List<cPickorder> pvPickorderObl) {
        ...
        this.recyclerViewQCOrders.setHasFixedSize(false);
        this.recyclerViewQCOrders.setAdapter(this.getPickorderAdapter());
        this.recyclerViewQCOrders.setLayoutManager(new LinearLayoutManager(cAppExtension.context));
    ...
    private  boolean mTryToLockOrderBln() {
        ...
        cResult hulpResult;
        hulpResult = cPickorder.currentPickOrder.pLockViaWebserviceRst(cWarehouseorder.StepCodeEnu.Pick_QualityContol, cWarehouseorder.WorkflowPickStepEnu.PickQualityControl);
    ...
    private void mReleaseLicense() {
        ...
        if (!cLicense.pReleaseLicenseViaWebserviceBln()) {
            cUserInterface.pShowSnackbarMessage(recyclerViewQCOrders, cAppExtension.activity.getString(R.string.message_license_release_error), null, false);
        }
