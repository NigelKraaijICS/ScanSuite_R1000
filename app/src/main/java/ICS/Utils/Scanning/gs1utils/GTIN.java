...
public final class GTIN {
    ...
    public static boolean convertibleToGTIN13(String gtin) {
        return isGTIN(gtin) && (gtin.length() <= 13 || startsWithNZeroes(gtin, 1));
    }
    ...
    public static boolean convertibleToGTIN12(String gtin) {
        return isGTIN(gtin) && gtin.length() <= 12 || startsWithNZeroes(gtin, gtin.length() - 12);
    }
    ...
    public static boolean convertibleToGTIN8(String gtin) {
        return isGTIN(gtin) && gtin.length() == 8 || startsWithNZeroes(gtin, gtin.length() - 8);
    }
