...
public class cBarcodeScanDefinitions {
    ...
    public static String BARCODEINTENT_DATALOGIC_CATEGORY="com.datalogic.decodewedge.decode_category";
    ...
    public static String BARCODEINTENT_ZEBRA_CATEGORY="nl.icsvertex.shopscan.decodewedge.decode_category";
    ...
    public static String BARCODEINTENT_TC55_CATEGORY="nl.icsvertex.shopscan.decodewedge.decode_category";
